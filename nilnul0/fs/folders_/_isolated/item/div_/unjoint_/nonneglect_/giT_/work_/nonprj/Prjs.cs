...
namespace nilnul.fs.folders_._isolated.item.div_.unjoint_.nonneglect_.giT_.work_.nonprj
{
	public class Prjs
	{
		...
		)
		{
			...
			{
				foreach (var item in new directory_.giT_.repo0work.Prjs(io).seq_ofAddress(dirAddress))
				{
					yield return item;
				} 

...
namespace nilnul.fs.folders_._unjoint.item.div_.delvable_.giT_.work_.nonneglect
{
	public class InsideModules
	{
		...
		)
		{
			...
			if (
				...
				nilnul.fs.folder_.git_.work.be_._TopX.__Be_ofAddress(folder)
				

				//new System.IO.DirectoryInfo(folder).EnumerateDirectories().Any(
